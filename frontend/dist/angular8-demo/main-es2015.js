...
const _c0 = [1, "navbar", "navbar-expand-lg", "navbar-light", "bg-light"];
const _c1 = ["type", "button", "data-toggle", "collapse", "data-target", "#navbarSupportedContent", "aria-controls", "navbarSupportedContent", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"];
const _c2 = [1, "navbar-toggler-icon"];
class AppComponent {
    constructor() {
...
const _c0 = [1, "col-md-6", "user-container"];
const _c1 = [1, "text-center"];
const _c2 = [3, "formGroup", "ngSubmit"];
const _c3 = [1, "form-group"];
const _c4 = ["for", "name_event"];
const _c5 = ["type", "text", "formControlName", "name_event", "placeholder", "Nombre del evento", "name", "name_event", "id", "name_event", 1, "form-control"];
const _c6 = ["for", "type_event"];
const _c7 = ["formControlName", "type_event", "placeholder", "Seleccione", "name", "type_event", "id", "type_event", 1, "form-control"];
const _c8 = ["value", "Curso"];
const _c9 = ["value", "Conferencia"];
const _c10 = ["value", "Seminario"];
const _c11 = ["value", "Congreso"];
const _c12 = ["for", "date_event"];
const _c13 = ["formControlName", "date_event", "placeholder", "AAAA-MM-DD", "name", "date_event", "id", "date_event", 1, "form-control"];
...
const _c2 = [3, "formGroup", "ngSubmit"];
const _c3 = [1, "hidden"];
const _c4 = ["type", "text", "formControlName", "id", "placeholder", "id", "name", "id", "id", "id", "hidden", "True", 1, "form-control"];
const _c5 = [1, "form-group"];
const _c6 = ["for", "name_event"];
const _c7 = ["type", "text", "formControlName", "name_event", "placeholder", "Nombre del evento", "name", "name_event", "id", "name_event", 1, "form-control"];
const _c8 = ["for", "type_event"];
const _c9 = ["formControlName", "type_event", "placeholder", "Seleccione", "name", "type_event", "id", "type_event", 1, "form-control"];
const _c10 = ["value", "Curso"];
const _c11 = ["value", "Conferencia"];
const _c12 = ["value", "Seminario"];
const _c13 = ["value", "Congreso"];
const _c14 = ["for", "date_event"];
const _c15 = ["formControlName", "date_event", "placeholder", "AAAA-MM-DD", "name", "date_event", "id", "date_event", 1, "form-control"];
const _c16 = [1, "btn", "btn-success"];
...
const _c0 = [1, "col-md-6", "user-container"];
const _c1 = [2, "margin", "auto"];
const _c2 = [1, "btn", "btn-danger", 2, "width", "100px", 3, "click"];
const _c3 = [1, "table", "table-striped"];
const _c4 = [1, "hidden"];
const _c5 = [4, "ngFor", "ngForOf"];
const _c6 = [1, "btn", "btn-success", 3, "click"];
const _c7 = [1, "btn", "btn-success", 2, "margin-left", "20px", 3, "click"];
function ListEventComponent_tr_17_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListEventComponent_tr_17_Template_button_click_12_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const event_r9 = ctx.$implicit; const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r12.editEvent(event_r9); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextBinding"](2, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinterpolation1"]("", event_r9.id, ""));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵselect"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextBinding"](4, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinterpolation1"]("", event_r9.name_event, ""));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵselect"](6);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextBinding"](6, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinterpolation1"]("", event_r9.date_event, ""));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵselect"](8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextBinding"](8, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinterpolation1"]("", event_r9.type_event, ""));
} }
...
const _c0 = [1, "row"];
const _c1 = [1, "col-md-6", "login-container"];
const _c2 = [2, "margin", "auto"];
const _c3 = [3, "formGroup", "ngSubmit"];
const _c4 = [1, "form-group"];
const _c5 = ["for", "username"];
const _c6 = ["type", "text", "formControlName", "username", "id", "username", "autocomplete", "off", 1, "form-control"];
const _c7 = ["class", "error", 4, "ngIf"];
const _c8 = ["for", "pwd"];
const _c9 = ["type", "password", "formControlName", "password", "id", "password", "autocomplete", "off", 1, "form-control"];
const _c10 = [1, "btn", "btn-success", 3, "disabled"];
const _c11 = [1, "btn", "btn-success", 3, "click"];
const _c12 = [1, "error"];
...
class ApiService {
    ...
    getEvents() {
        const payload = { username: window.localStorage.getItem('token') };
